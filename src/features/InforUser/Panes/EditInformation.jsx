        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="input-admin">
            ...
            <div className="update">
              ...
              {linkImg ? (
                <img loading="lazy" src={linkImg} className="img-update" height="150px" width="250px" alt="" />
              ) : imgId ? (
                <img loading="lazy" src={imgId} className="img-update" height="150px" width="250px" alt="" />
              ) : (
                ''
              )}
              <br />
